  ...
  return (
    <>
      <HeroSection
        ...
        breadcrumb="SOLUTIONS > PRODUCTIVITY"
        title="Productivity"
        ...
        offers={[
          {
            ...
            description: "Speak directly with our specialists about your requirements.",
          },
          {
            title: "Custom Implementation",
            description: "Tailored solutions designed to fit your unique business context.",
          },
          {
            title: "24/7 Support",
            description: "Round-the-clock monitoring and support for all our implementations.",
          },
          {
